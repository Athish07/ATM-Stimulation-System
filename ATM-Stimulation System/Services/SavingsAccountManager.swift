...
extension SavingsAccountManager {
    ...
    private func validateTransactionLimit(accountNumber: UUID, amount: Double)
        throws
    {
    ...
    private func sumAmount(
        amountSum: inout Double,
...
enum TransactionLimitError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .perDayLimitExceed:
            return
                "Cannot proceed with the transaction amount is more than per day limit."
        case .perMonthLimitExceed:
            return
                "Cannot proceed with the transaction amount is more than per month limit."
        case .perYearLimitExceed:
            return
                "Cannot proceed with the transaction amount is more than per year limit."
        }
